...
Владелец согласовал еженедельный host-таймер вместо первоначально планировавшегося workflow внутри n8n: восстановление дампа должно выполняться и при отказе n8n. После настройки Telegram создана новая локальная копия `20260925T170609Z`; все три контрольные суммы совпали. Зашифрованный USB-снимок пока старше этой копии.
...
- отказ Redis под нагрузкой; повторная отправка Telegram после ротации токена;
