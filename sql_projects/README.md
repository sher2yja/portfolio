...
| [Изменение данных](./pizzeria-sql-dml) | Четырнадцать запросов к той же базе. Половина читает данные, половина меняет: `INSERT`, `UPDATE` и `DELETE` идут цепочкой, где каждый шаг опирается на предыдущий. Повторный запуск здесь не проверка, поэтому прогон начинается с пересоздания базы | ![PostgreSQL](https://img.shields.io/badge/PostgreSQL-4169E1?style=flat-square&logo=postgresql&logoColor=white) ![ANSI SQL](https://img.shields.io/badge/ANSI%20SQL-336791?style=flat-square) ![Bash](https://img.shields.io/badge/Bash-4EAA25?style=flat-square&logo=gnu-bash&logoColor=white) |
| [Представления и снимки данных](./pizzeria-sql-views) | Девять запросов к той же базе. Обычное представление хранит запрос и не может устареть, материализованное хранит результат и живёт своей жизнью до `REFRESH`. Стартовое состояние базы воспроизводится прогоном DML-скриптов соседнего проекта | ![PostgreSQL](https://img.shields.io/badge/PostgreSQL-4169E1?style=flat-square&logo=postgresql&logoColor=white) ![ANSI SQL](https://img.shields.io/badge/ANSI%20SQL-336791?style=flat-square) ![Bash](https://img.shields.io/badge/Bash-4EAA25?style=flat-square&logo=gnu-bash&logoColor=white) |
